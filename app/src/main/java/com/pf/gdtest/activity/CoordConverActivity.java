...
public class CoordConverActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_coord_conver);
        init();
    }
    ...
    public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
        ...
        CoordinateConverter.CoordType mcoordtype = CoordinateConverter.CoordType.valueOf(coordString);

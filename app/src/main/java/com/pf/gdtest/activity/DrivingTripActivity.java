...
public class DrivingTripActivity
        extends Activity
...
//    private LatLonPoint mEndPoint = new LatLonPoint(39.995576, 116.481288);//终点，116.481288,39.995576
    ...
    private LatLonPoint mStartPoint = new LatLonPoint(39.10322, 117.201168);//起点，117.201168,39.10322
    private LatLonPoint mEndPoint = new LatLonPoint(39.89584, 116.40466);//终点，116.40466,39.89584
    ...
    protected void onCreate(Bundle bundle) {
        ...
        setContentView(R.layout.activity_driving_trip);
    ...
    private void registerListener() {
        aMap.setOnMapClickListener(DrivingTripActivity.this);
        aMap.setOnMarkerClickListener(DrivingTripActivity.this);
        aMap.setOnInfoWindowClickListener(DrivingTripActivity.this);
        aMap.setInfoWindowAdapter(DrivingTripActivity.this);
    }
...
//                    });
            ...
            Toast.makeText(mContext, "错误:" + errorCode, Toast.LENGTH_SHORT).show();
        }
    }
